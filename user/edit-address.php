...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    mysqli_query($conn, "UPDATE users SET address = '$address', city = '$city', state = '$state', zip_code = '$zip_code' WHERE id = '$user_id'");
...
<head>
    ...
    <title>Edit Address - UHD-Wears</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ============================================
           FORM STYLES - ALL INPUTS WHITE TEXT
           ============================================ */
        .form-label {
            color: #ffffff;
            font-weight: 500;
        ...
        /* ALL form controls - WHITE TEXT for visibility */
        .form-control, 
        .form-select,
        input.form-control,
        select.form-select,
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item active" href="edit-address.php"><i class="fas fa-map-marker-alt me-2"></i> Edit Address</a></li>
            ...
            <div class="col-md-3 mb-4">
                <div class="sidebar-dash" id="sidebar">
                    <div class="text-center mb-4">
                        <div class="avatar-circle" style="width: 75px; height: 75px; background: linear-gradient(135deg, #FFD700, #FFC107); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                            <i class="fas fa-map-marker-alt" style="font-size: 35px; color: #000;"></i>
                        </div>
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="edit-address.php"><i class="fas fa-map-marker-alt"></i> Edit Address</a>
                        <hr style="border-color: rgba(255,255,255,0.1);">
            ...
            <div class="col-md-9">
                <div class="edit-card">
                    <div class="card-header">
                        <h4><i class="fas fa-map-marker-alt me-2"></i> Edit Delivery Address</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST">
                            <div class="mb-4">
                                ...
                                <textarea name="address" class="form-control" rows="3" placeholder="Enter your complete address"><?php echo htmlspecialchars($user['address']); ?></textarea>
                                <small class="text-muted" style="color: #aaa;"><i class="fas fa-info-circle me-1"></i> Enter your complete street address</small>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="zip_code" class="form-control" value="<?php echo htmlspecialchars($user['zip_code']); ?>" placeholder="Enter ZIP code">
                                </div>
                            </div>
